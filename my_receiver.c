...
if(a==0 && b==1){add_new_bit_at_end_remove_old_bit_at_start(0);get_numbers_and_characters_from_raw_binary();while(get_rs485_ch_one_line_A()==0 && get_rs485_ch_one_line_B()==1){}}     
if(a==1 && b==0){add_new_bit_at_end_remove_old_bit_at_start(1);get_numbers_and_characters_from_raw_binary();while(get_rs485_ch_one_line_A()==1 && get_rs485_ch_one_line_B()==0){}}
